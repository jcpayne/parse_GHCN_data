---
title: "Convert GHCN daily weather to a useful format"
author: "J. Payne"
date: "5/6/2017"
...
Let's assume that you have downloaded a sample file called "MBM00044354.dly" from the daily FTP directory (either /all or /by_year).  The file contains all weather records for the station.  Now use the function to convert the data to a reasonable format.
```{r, eval=FALSE}
...
but data from some weather stations include many other variables.  See GHCN readme for more information, at ftp://ftp.ncdc.noaa.gov/pub/data/ghcn/daily/readme.txt. If you're only interested in one variable, just use regular R subsetting to get it:
````{r, eval=FALSE}rain<-df[df$variable=="PRCP",]````
